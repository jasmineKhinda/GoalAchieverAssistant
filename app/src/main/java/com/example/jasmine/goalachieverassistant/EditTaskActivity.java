...
//        // Create an adapter that knows which fragment should be shown on each page
        CustomPagerFragmentAdapterTask adapter = new CustomPagerFragmentAdapterTask(this, getSupportFragmentManager(), taskKey);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (item.getItemId() == android.R.id.home) {
            ...
            if(TextUtils.isEmpty(taskTitle.getText())){
                ...
                taskTitle.setError(Utilities.getSpannableStringForErrorOutput("Enter Goal Name", Color.WHITE));
